...
if __name__ == "__main__":
    ...
    episodes_without_intrusions = 0  # Count collision-free episodes
    ...
    for episode in range(1, NUM_EVAL_EPISODES + 1):
        ...
        while env.agents:
            ...
            actions_tensor = action_dist.loc
        ...
        # Track collision-free episodes
        if env.total_intrusions == 0:
            episodes_without_intrusions += 1
    ...
    collision_free_rate = (episodes_without_intrusions / NUM_EVAL_EPISODES) * 100
    ...
    print(f"  - Episodes Without Intrusions: {episodes_without_intrusions}/{NUM_EVAL_EPISODES} ({collision_free_rate:.1f}%)")
