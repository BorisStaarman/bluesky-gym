...
# code for model 7 SAC_AM/12_5 with attention mechanism
# IMPORTANT: This requires attention_model_M.py to be importable!
import sys
import os
...
from attention_model_M import AttentionSACModel  # Direct import since directory is in sys.path
...
# Create runtime environment so Ray workers can find attention_model_M
runtime_env = {
...
export_policy_torch_old_api(
    r"C:\Users\boris\Documents\bsgym\bluesky-gym\SAC_AM\12_5\models\sectorcr_ma_sac\best_iter_14827",
    "shared_policy",
    r"C:\Users\boris\BS_setup\bluesky-master\plugins\models_boris\SAC_AM_8.pt",
