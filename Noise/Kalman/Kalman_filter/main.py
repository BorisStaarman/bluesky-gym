...
from ma_env_lstm import SectorEnvLSTM as SectorEnv
    ...
    cfg = (
        ...
        .environment(
            ...
            env_config={
                ...
                # LSTM denoiser settings
                "denoiser_path": os.path.join(script_dir, "denoiser_models", "lstm_denoiser_best.pt"),
                "use_denoiser": True,
                "noise_enabled": True,
            },
...
if __name__ == "__main__":
    ...
    ray.shutdown()
    # Initialize Ray with runtime environment so workers can find modules
    ray.init(runtime_env={
        "working_dir": script_dir,
        "py_modules": [
            os.path.join(script_dir, "attention_model_A.py"),
            os.path.join(script_dir, "lstm_denoiser.py"),
            os.path.join(script_dir, "ma_env_lstm.py"),
            os.path.join(script_dir, "ma_env.py"),
        ],
    })
