...
WARMUP_ITERATIONS = 3  # Number of iterations to warm up critic with frozen policy
# --- STAGE 2: RL FINE-TUNING (PPO with standard loss) ---
TOTAL_ITERS = WARMUP_ITERATIONS + 50   # set to 300 or something for ppo
...
if __name__ == "__main__":
    ...
    for i in range(1, target_iters+1):
        ...
        if i <= WARMUP_ITERATIONS:
            ...
            print(f"Stage 2 {phase_indicator} - Iter {i}/{target_iters} | Reward: {mean_rew:.3f} | Loss: {total_loss:.3f} | Entropy: {entropy:.3f}")
