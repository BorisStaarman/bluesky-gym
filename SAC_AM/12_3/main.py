...
from attention_model import AttentionSACModel # Assuming you saved Step 1 as attention_model.py
...
EARLY_STOP_PATIENCE = 10001        # Number of iterations without improvement before stopping
