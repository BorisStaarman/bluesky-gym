...
"""
================================================================================
SAC TRAINING WITH MODIFIED ATTENTION ARCHITECTURE
================================================================================
...
The query projection layer has changed from 7→5 (ownship) to 5→5 (intruder),
making pre-trained weights incompatible with the original architecture.
...
TOTAL_ITERS = 180   # 18000 Maximum total iterations
