...
STEP_PENALTY = -0.05  # Small penalty per timestep to encourage efficiency
...
COLLISION_PENALTY = -200.0  # One-time penalty for collision with another aircraft
    ...
    def _get_reward(self, active_agents):
        ...
        for agent in active_agents:
            ...
            if agent in self.collided_agents:
                ...
                rewards[agent] = COLLISION_PENALTY / 400.0  # Apply same normalization
            ...
            try:
                ...
                rewards[agent] = (drift_reward + intrusion_reward + 
                                ...
                                boundary_penalty + proximity_penalty + step_penalty + collision_penalty) / 400.0
