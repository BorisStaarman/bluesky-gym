...
BOUNDARY_VIOLATION_PENALTY = -200.0  # Penalty for leaving polygon boundary (not at waypoint)
PROGRESS_REWARD_SCALE = 120.0  # Scale factor for distance-to-waypoint progress
    ...
    def _get_reward(self, active_agents):
        ...
        for agent in active_agents:
            ...
            try:
                ...
                rewards[agent]  = ( intrusion_reward + step_penalty + progress_reward + proximity_penalty + boundary_penalty ) / 500.0
