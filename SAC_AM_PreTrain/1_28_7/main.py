...
BURN_IN_ACTOR_LR_LOCAL = 1e-6     # Jouw 'ancre' voor navigatie-stabiliteit
BURN_IN_ATTENTION_LR_LOCAL = 5e-5   # Krachtig genoeg voor focus
BURN_IN_CRITIC_LR_LOCAL = 5e-5      # VERHOOGD: De Critic moet de expert snappen!
...
CURRENT_INTRUSION_PENALTY = -150  # Start with Stage 1
