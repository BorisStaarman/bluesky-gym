...
NUM_EVAL_EPISODES = 50  # 600 episodes: 300 probe + 300 reference for bootstrap convergence analysis
...
MANUAL_CHECKPOINT_ITER = 23558  # Best checkpoint from 2_4_2 run (best_iter_19705_low_i)
