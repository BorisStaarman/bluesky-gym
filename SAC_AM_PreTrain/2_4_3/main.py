...
TOTAL_ITERS = 20000   # Not used when resuming (target = algo.iteration + EXTRA_ITERS)
EXTRA_ITERS = 4000         # Resume from checkpoint: run 4000 more iterations (~19705 → 23705)
FORCE_RETRAIN = False      # RESUME from best_iter_19705_low_i checkpoint
...
ENABLE_BURN_IN = False        # Skip burn-in: resuming from well-trained checkpoint
