...
WAYPOINT_REACHED_REWARD =300.0  # Reward for reaching waypoint
    ...
    def _get_reward(self, active_agents):
        ...
        for agent in active_agents:
            ...
            try:
                ...
                rewards[agent]  = ( intrusion_reward + step_penalty + drift_reward + progress_reward + proximity_penalty + boundary_penalty ) / 12000.0
