...
INTRUSION_CURRICULUM_STAGES = [
    (0, -100),      # Stage 1 (iter 0-4000): Learn waypoint navigation
    (4000, -175),   # Stage 2 (iter 4000-8000): Add collision awareness
    (8000, -250),   # Stage 3 (iter 8000-12000): Master both skills
]
