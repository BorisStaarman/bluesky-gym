...
class ForceAlphaCallback(DefaultCallbacks):
    ...
    def on_train_result(self, *, algorithm, result, **kwargs):
        ...
        DECAY_UNTIL  = 18000  # UPGRADED: 10K→11K slower decay prevents iter 3K-4K crisis
        ...
        ALPHA_FINAL  = 0.04  # UPGRADED: 0.01→0.015 (50% more exploration)
