...
# --- Parameters ---
N_AGENTS = 30  # Number of agents for training
TOTAL_ITERS = 5000  # Maximum total iterations
...
def build_trainer(n_agents):
    ...
    cfg = (
        ...
        .training(
            ...
            target_entropy = -1,   # -1.0 for more exploration. larger negative value is more exploitation
            # alpha_lr = 1e-5,            # was 3e-5.   lr for updating entropy / alpha. lower means slower alpha updates
            alpha_lr=[
                [0,        1e-5],   # from step 0 to 1M: 3e-4
                [TOTAL_ITERS/2, 5e-6],
